...
public class TheInstructors {

    private String name, phonenumber, email, gender, uid;
    private int imageUrl;

    public TheInstructors() {
        // empty constructor
    }

    public TheInstructors(int imageUrl, String name, String phonenumber, String email, String gender, String uid ) {
