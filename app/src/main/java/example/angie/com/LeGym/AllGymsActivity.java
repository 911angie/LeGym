...
import static example.angie.com.LeGym.AppConfig.GEOMETRY;
import static example.angie.com.LeGym.AppConfig.GOOGLE_BROWSER_API_KEY;
import static example.angie.com.LeGym.AppConfig.LATITUDE;
import static example.angie.com.LeGym.AppConfig.LOCATION;
import static example.angie.com.LeGym.AppConfig.LONGITUDE;
import static example.angie.com.LeGym.AppConfig.NAME;
import static example.angie.com.LeGym.AppConfig.OK;
import static example.angie.com.LeGym.AppConfig.RESULTS;
import static example.angie.com.LeGym.AppConfig.STATUS;
import static example.angie.com.LeGym.AppConfig.VICINITY;
import static example.angie.com.LeGym.AppConfig.ZERO_RESULTS;

public class AllGymsActivity extends AppCompatActivity implements OnMapReadyCallback  {
    ...
    private static final String TAG = AllGymsActivity.class.getSimpleName();
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, googlePlacesUrl.toString(), null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(AllGymsActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
        );
        queue.add(request);
    ...
    public void parseLocationResult(JSONObject result) {
        try {
            ...
            if (result.getString(STATUS).equalsIgnoreCase(OK)) {
                ...
                Toast.makeText(AllGymsActivity.this, "No gyms available", Toast.LENGTH_LONG).show();
            }
        } catch (JSONException e) {
            e.printStackTrace();
            Toast.makeText(AllGymsActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
        }
    }
