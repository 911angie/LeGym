        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if( !usernameET.getText().toString().isEmpty() && !homeET.getText().toString().isEmpty() &&
                    ...
                    Toast.makeText( MyProfileActivity.this, "Fill all fields", Toast.LENGTH_SHORT ).show();
                }
            }
        });
    }
        ...
        mDatabase.orderByChild("email").equalTo(email).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if( dataSnapshot.exists() ) {
                    ...
                    Toast.makeText( MyProfileActivity.this, "Email not found", Toast.LENGTH_SHORT ).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText( MyProfileActivity.this, "Ref cancelled", Toast.LENGTH_SHORT ).show();
            }
        });
    }
